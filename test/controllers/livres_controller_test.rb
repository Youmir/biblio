...
class LivresControllerTest < ActionController::TestCase
  ...
  test "should create livre" do
    assert_difference('Livre.count') do
      post :create, livre: { auteur: @livre.auteur, estDispo: @livre.estDispo, estValide: @livre.estValide, isbn: @livre.isbn, titre: @livre.titre }
    end
  ...
  test "should update livre" do
    patch :update, id: @livre, livre: { auteur: @livre.auteur, estDispo: @livre.estDispo, estValide: @livre.estValide, isbn: @livre.isbn, titre: @livre.titre }
    assert_redirected_to livre_path(assigns(:livre))
  end
